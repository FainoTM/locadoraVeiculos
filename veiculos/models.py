...
class Contrato(models.Model):
    numEscritorio = models.OneToOneField(Escritorio, on_delete=models.CASCADE)
    cliente = models.OneToOneField(Cliente, on_delete=models.DO_NOTHING)
    veiculo = models.OneToOneField(Veiculo, on_delete=models.DO_NOTHING, limit_choices_to={'disponivel': True})
